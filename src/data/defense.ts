...
const methode: Analyse = {
  ...
  sections: [
    ...
    argument(
      ...
      'En reconstituant à partir des achats, le fisc obtient un CA liquide de **165 065 €** alors que la caisse n’a encaissé que **106 113 €** (+ 55,6 %), puis l’**amplifie × 3,1** sur une cuisine jamais mesurée. En réinjectant le **vrai** CA liquide dans sa **propre formule** (× 3,1, abattement 15 %), la discordance **s’inverse à −65 721 €** : aucune occultation. Nous l’avons recalculé sur les pièces réelles.',
      'forte',
      [preuve('boissons-disparues')],
    ),
    argument(
      ...
      'Le fisc déduit **lui-même** la cuisine produit par produit (Macvin 7 406 cl, **Calvados = 103 % de l’achat**, Absinthe 100 %, Vin Jaune 61 %…) mais maintient un abattement global de **15 %**. La jurisprudence admet **22 à 25 %** (CAA Paris 17/03/2021), et l’écart réel mesuré sur la caisse atteint **35,7 %**. Les **achats Intermarché** ne sont pas non plus investigués (p. 53).',
      'modérée à forte',
      [preuve('boissons-disparues')],
    ),
    argument(
